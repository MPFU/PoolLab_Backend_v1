...
namespace PoolLab.WebAPI.Controllers
{
    ...
    public class BilliardTableController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SearchTableForBookingInDate([FromBody] SearchTableBookingDTO searchDTO)
        {
            try
            {

                var requestResult = await _billiardTableService.SearchTableForBooking(searchDTO);
